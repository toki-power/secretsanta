...
import faviconToki from '../../static/Favicon_Toki.svg';
  ...
  return (
    <div className={`shadow-md relative z-10 transform rotate-2 transition-transform duration-300 p-3 bg-postcard rounded-lg ${className}`}>
      <div className="relative p-8 bg-white">
        ...
        <div className="absolute -top-6 -right-6 w-12 h-12 bg-[#FFFFFF] rounded-full flex items-center justify-center transform rotate-12">
          <img className={`w-3/4 h-3/4`} src={faviconToki} />
        </div>

        {children}

        <div className="absolute -bottom-6 -left-6 w-12 h-12 bg-[#FFFFFF] rounded-full flex items-center justify-center transform -rotate-12">
          <img className={`w-3/4 h-3/4`} src={faviconToki} />
        </div>
